...
if(empty($is_verified_envato_purchase_code)) {
  add_filter('http_request_args', 'grandtour_http_request_args', 100, 1);
  function grandtour_http_request_args($r) 
  {
    $r['timeout'] = 30;
    return $r;
  }
   
  add_action('http_api_curl', 'grandtour_http_api_curl', 100, 1);
  function grandtour_http_api_curl($handle) 
  {
