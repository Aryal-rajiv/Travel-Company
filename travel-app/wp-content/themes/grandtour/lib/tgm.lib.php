...
function grandtour_require_plugins() {
    ...
    $plugins = array(
	    array(
	        ...
	        'source'             => 'https://themegoods-assets.b-cdn.net/grandtour-custom-post/grandtour-custom-post-v2.4.2.zip',
	        'required'           => true, 
	        'version'            => '2.4.2',
	    ),
	    array(
	    ...
	    array(
			...
			'slug'               => 'revslider',
			'source'             => 'https://themegoods-assets.b-cdn.net/revslider/revslider-v6.6.16.zip',
			'required'           => true, 
			'version'            => '6.6.16',
		),
	    array(
	        'name'               => 'Booked',
	        'slug'      		=> 'booked',
	        'source'             => 'https://themegoods-assets.b-cdn.net/booked/booked-v2.4.4.zip',
	        'required'           => true, 
	        'version'            => '2.4.4',
	    ),
	    array(
			'name'               => 'Envato Market',
			'slug'               => 'envato-market',
			'source'             => 'https://themegoods-assets.b-cdn.net/envato-market/envato-market-v2.0.10.zip',
			'required'           => true, 
			'version'            => '2.0.10',
		),
	    array(
