...
Plugin URI: https://themes.themegoods.com/grandtour/demo/
		...
		array (
			...
			'tour' => array(
				...
				array(
					...
					"id" 			=> "page_menu_normal", 
					"type" 			=> "checkbox", 
					"title" 		=> esc_html__("Make Menu Normal", 'grandtour-custom-post'),
					"description" 	=> esc_html__("Check this option if you want to display main menu in default state instead of transparent", 'grandtour-custom-post'),
				),
			),
